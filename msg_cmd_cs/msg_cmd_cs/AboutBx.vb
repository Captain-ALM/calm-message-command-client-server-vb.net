...
Public NotInheritable Class AboutBx
    ...
    Private Sub AboutBx_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.TextBoxDescription.Text = "Description: " & vbCrLf & My.Application.Info.Description & vbCrLf & vbCrLf & "Captain ALM Client & Server Library Version: " & GetType(captainalm.calmclientandserver.packet).Assembly.GetName.Version.ToString & vbCrLf & vbCrLf & description
